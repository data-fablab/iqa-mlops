        ...
        if lifecycle:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "active_cache_status": "Cache actif",
                    "candidate_cache_status": "Cache candidat",
                    ...
                    "alert_rate": st.column_config.NumberColumn("Taux a verifier", format="%.3f"),
                    "good_red_rate": st.column_config.NumberColumn("Taux faux non conformes", format="%.3f"),
                    "gate": "Gate",
                    "promotion": "Promotion",
                    "stage": "Stage",
                    "registry": "Registry",
