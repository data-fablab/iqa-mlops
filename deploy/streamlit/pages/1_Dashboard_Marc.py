        ...
        if lifecycle:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "aupimo_unstable": "AUPIMO instable",
                    "low_fpr_good_outlier_count": "Outliers good",
                    "max_good_score": st.column_config.NumberColumn("Max good", format="%.6f"),
                    "max_defect_score": st.column_config.NumberColumn("Max defect", format="%.6f"),
                    "classes": "Classes",
                    "gate": "Gate",
                    "promotion": "Promotion",
                    "stage": "Stage",
