...
MANIFEST_CONTRACTS: dict[str, MetadataManifestContract] = {
    ...
    "natural_replay": MetadataManifestContract(
        key="natural_replay",
        path=Path("data/metadata/casting_flux_replay_plan_natural.csv"),
        kind="replay",
    ...
    "validation_set": MetadataManifestContract(
        key="validation_set",
        path=Path("data/validation/validation_set_v001.csv"),
        kind="validation",
        manifest_id="validation_set_v001",
    ...
    "calibration_set": MetadataManifestContract(
        key="calibration_set",
        path=Path("data/metadata/calibration_set_v001.csv"),
        kind="calibration",
        manifest_id="calibration_set_v001",
        dataset_version="calibration_set_v001",
        historical_columns=CALIBRATION_COLUMNS,
        identity_column="event_id",
    ),
}
