...
MANIFEST_CONTRACTS: dict[str, MetadataManifestContract] = {
    ...
    "bootstrap_piece_b_minimal": MetadataManifestContract(
        key="bootstrap_piece_b_minimal",
        path=Path("data/metadata/feature_ae_bootstrap_piece_b_minimal_v001.csv"),
        kind="bootstrap",
        manifest_id="feature_ae_bootstrap_piece_b_minimal_v001",
        dataset_version="feature_ae_piece_b_minimal_bootstrap_v001",
        historical_columns=BOOTSTRAP_COLUMNS,
        identity_column="event_id",
    ),
    ...
    "natural_replay_piece_b_full": MetadataManifestContract(
        key="natural_replay_piece_b_full",
        path=Path("data/metadata/casting_flux_replay_plan_piece_b_full_v001.csv"),
        kind="replay",
        manifest_id="casting_flux_replay_plan_piece_b_full_v001",
        dataset_version="production_replay_natural_piece_b_full",
        historical_columns=REPLAY_COLUMNS,
        identity_column="simulated_event_id",
        replay_id="production_replay_natural_piece_b_full",
        scenario_version="casting_flux_replay_plan_piece_b_full_v001",
        scenario_id="production_replay_natural_piece_b_full",
    ),
    "natural_replay_piece_b_to_piece_a_p4_drift": MetadataManifestContract(
        key="natural_replay_piece_b_to_piece_a_p4_drift",
        path=Path("data/metadata/casting_flux_replay_plan_piece_b_to_piece_a_p4_drift_v001.csv"),
        kind="replay",
        manifest_id="casting_flux_replay_plan_piece_b_to_piece_a_p4_drift_v001",
        dataset_version="production_replay_natural_piece_b_to_piece_a_p4_drift",
        historical_columns=REPLAY_COLUMNS,
        identity_column="simulated_event_id",
        replay_id="production_replay_natural_piece_b_to_piece_a_p4_drift",
        scenario_version="casting_flux_replay_plan_piece_b_to_piece_a_p4_drift_v001",
        scenario_id="production_replay_natural_piece_b_to_piece_a_p4_drift",
    ),
    "natural_replay_piece_b_minimal": MetadataManifestContract(
        key="natural_replay_piece_b_minimal",
        path=Path("data/metadata/casting_flux_replay_plan_piece_b_minimal_v001.csv"),
        kind="replay",
        manifest_id="casting_flux_replay_plan_piece_b_minimal_v001",
        dataset_version="production_replay_natural_piece_b_minimal",
        historical_columns=REPLAY_COLUMNS,
        identity_column="simulated_event_id",
        replay_id="production_replay_natural_piece_b_minimal",
    ...
    "validation_piece_b_minimal": MetadataManifestContract(
        key="validation_piece_b_minimal",
        path=Path("data/validation/validation_set_piece_b_minimal_v001.csv"),
        kind="validation",
        manifest_id="validation_set_piece_b_minimal_v001",
        dataset_version="validation_set_piece_b_minimal_v001",
        historical_columns=VALIDATION_COLUMNS,
        identity_column="event_id",
        validation_id="validation_set_piece_b_minimal_v001",
